...
class CollisionRay {
  ...
  static List<IntersectionData> getSightPolygon(
      List<Segment> segments, Vector sight) {
    ...
    List<IntersectionData> intersects =
        raysAllDirections(uniqueAngles, sight, segments);
  ...
  static List<IntersectionData> raysAllDirections(
      List<double> uniqueAngles, Vector sight, List<Segment> segments) {
